...
public class InstanciaJpaController implements Serializable {
    ...
    public void create(Instancia instancia) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findInstancia(instancia.getCodInstancia()) != null) {
                throw new PreexistingEntityException("Instancia " + instancia + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(Instancia instancia) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = instancia.getCodInstancia();
